...
module.exports.handleEvent = function({ api, event }) {
  ...
  if ((event.body.toLowerCase() == "Phùng Quang Trung") || (event.body.toLowerCase() == "Phùng Quang Trung")) {
  ...
  if ((event.body.toLowerCase() == "admin mày là ai vậy bot") || (event.body.toLowerCase() == "admin m la ai v bot")) {
    return api.sendMessage("️Admin tao là sếp Phùng Quang Trung", threadID);
  };
  ...
  if ((event.body.toLowerCase() == "@Trung Phùng Quang") || (event.body.toLowerCase() == "@Trung Phùng Quang")) {
